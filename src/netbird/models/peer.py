...
class PeerUpdate(BaseModel):
    ...
    login_expiration_enabled: Optional[bool] = Field(None, description="Login expiration enabled")
    inactivity_expiration_enabled: Optional[bool] = Field(None, description="Inactivity expiration enabled")
    approval_required: Optional[bool] = Field(None, description="Approval required (cloud-only)")
...
class Peer(BaseModel):
    ...
    groups: Optional[List[Dict[str, Any]]] = Field(None, description="Group objects with details")
    ...
    login_expiration_enabled: bool = Field(False, description="Login expiration enabled")
    ...
    accessible_peers_count: Optional[int] = Field(None, description="Number of accessible peers")
    ...
    extra_dns_labels: Optional[List[str]] = Field(None, description="Additional DNS labels")
