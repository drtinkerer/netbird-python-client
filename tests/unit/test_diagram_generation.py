...
class TestDiagramGeneration:
    ...
    def test_generate_diagram_mermaid_format(self, test_client, sample_network_map_data, sample_topology_data):
    ...
    def test_generate_diagram_mermaid_with_output_file(self, test_client, sample_network_map_data, sample_topology_data):
        ...
        with patch('netbird.network_map.generate_full_network_map') as mock_network_map, \
            ...
            result = test_client.generate_diagram(format="mermaid", output_file="test_diagram")
    ...
    def test_generate_diagram_graphviz_format(self, test_client, sample_network_map_data, sample_topology_data):
        ...
        with patch('netbird.network_map.generate_full_network_map') as mock_network_map, \
            ...
            with patch.object(test_client, '_create_graphviz_diagram') as mock_method:
                ...
                result = test_client.generate_diagram(format="graphviz", output_file="test_graphviz")
                
                # Should not return anything for graphviz (saves files directly)
                assert result is None
                mock_method.assert_called_once()

    def test_generate_diagram_graphviz_import_error(self, test_client, sample_network_map_data, sample_topology_data):
        ...
        with patch('netbird.network_map.generate_full_network_map') as mock_network_map, \
            ...
            with patch('netbird.client.APIClient._create_graphviz_diagram') as mock_method:
                mock_method.return_value = None
    ...
    def test_generate_diagram_diagrams_format(self, test_client, sample_network_map_data, sample_topology_data):
        ...
        with patch('netbird.network_map.generate_full_network_map') as mock_network_map, \
            ...
            with patch.object(test_client, '_create_diagrams_diagram') as mock_method:
                ...
                result = test_client.generate_diagram(format="diagrams", output_file="test_diagrams")
                
                assert result == "test_diagrams.png"
                mock_method.assert_called_once()

    def test_generate_diagram_diagrams_import_error(self, test_client, sample_network_map_data, sample_topology_data):
    ...
    def test_generate_diagram_invalid_format(self, test_client, sample_network_map_data):
    ...
    def test_generate_diagram_with_options(self, test_client, sample_network_map_data, sample_topology_data):
        ...
        with patch('netbird.network_map.generate_full_network_map') as mock_network_map, \
            ...
            assert result is not None
            mock_network_map.assert_called_once_with(
                test_client, False, False, True
            )
    ...
    def test_format_policy_label(self, test_client):
        ...
        label = test_client._format_policy_label(['policy1', 'policy1', 'policy2'], "Group")
        assert label.startswith("Group: ")
        assert 'policy1' in label and 'policy2' in label
    ...
    def test_sanitize_id(self, test_client):
        ...
        test_cases = [
            ...
            ("test/group", "test_group"),
            ("test group", "test_group"),
            ("complex-test.group/name with spaces", "complex_test_group_name_with_spaces")
        ]
    ...
    def test_mermaid_diagram_structure(self, test_client, sample_network_map_data, sample_topology_data):
...
class TestDiagramHelperMethods:
    ...
    def test_sanitize_id_special_characters(self, test_client):
        ...
        # The sanitize_id method replaces all non-alphanumeric characters (except underscore) with underscores
