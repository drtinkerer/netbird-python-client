...
class TestInvoiceResource:
    ...
    def test_get_pdf_url(self):
        self.mock_client.get.return_value = {"url": "https://billing.example.com/inv-1.pdf"}
        result = self.resource.get_pdf_url("inv-1")
        self.mock_client.get.assert_called_once_with("integrations/billing/invoices/inv-1/pdf")
        assert "url" in result

    def test_get_csv(self):
        self.mock_client.get.return_value = {"data": "id,amount\ninv-1,9900"}
        result = self.resource.get_csv("inv-1")
        self.mock_client.get.assert_called_once_with("integrations/billing/invoices/inv-1/csv")
