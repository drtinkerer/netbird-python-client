...
class TestClientCompleteCode:
    ...
    def test_client_put_method(self):
        ...
        with patch.object(client.client, 'put') as mock_put:
            ...
            result = client.put("test-path", data={"name": "test"}, params={"filter": "active"})
...
class TestEventsResourceCompleteCode:
    ...
    def test_get_network_traffic_events_all_params(self):
        ...
        self.mock_client.get.assert_called_once_with("events/network-traffic", params=expected_params)
...
class TestGroupsResourceCompleteCode:
    ...
    def test_update_group(self):
        ...
        update_data = GroupUpdate(name="updated-group", peers=["peer-1", "peer-2", "peer-3"])
...
class TestNetworksResourceCompleteCode:
    ...
    def test_update_network(self):
        ...
        update_data = NetworkUpdate(name="updated-network", description="Updated description")
    ...
    def test_delete_resource(self):
        ...
        self.mock_client.delete.assert_called_once_with("networks/network-123/resources/resource-123")
    ...
    def test_delete_router(self):
        ...
        self.mock_client.delete.assert_called_once_with("networks/network-123/routers/router-123")
...
class TestTokensResourceCompleteCode:
    ...
    def test_delete_token(self):
        ...
        self.mock_client.delete.assert_called_once_with("users/user-123/tokens/token-123")